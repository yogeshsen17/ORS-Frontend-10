...
export class ManagerComponent extends BaseCtl implements OnInit {
  ...
  validateForm(form) {
    ...
    flag = flag && validator.isNotNullObject(form.managerName);
    flag = flag && validator.isNotNullObject(form.branchName);
  ...
  populateForm(form, data) {
    ...
    form.branchName = data.branchName;
